...
// the URL as in http://localhost:8080/Mod_08_JPA_Server_presenter/services/compound
@Path("compound")
public class CompoundInterestService {
    ...
    public CompoundBeanEntity postCompoundInterest(CompoundBeanEntity compoundBeanEntity) {
        LOG.log(Level.INFO, "Input: {0}", compoundBeanEntity);
        calculateCompoundInterest(compoundBeanEntity);
        LOG.log(Level.INFO, "Output: {0}", compoundBeanEntity);
