...
public class CompoundInterestService {
     ...
     * http://localhost:8080/Mod_04_RestServer_presenter/services/compound?principal=100.00&annualInterestRate=0.05&compoundPerTimeUnit=12.0&time=5.0
    ...
    public CompoundBean sayCompoundInterest(
        ...
        //System.out.println(compoundBean.toString());
        return compoundBean;
    }
